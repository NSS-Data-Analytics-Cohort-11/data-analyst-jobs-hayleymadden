-- Intial analysis database preview
...
SELECT 
	DISTINCT company AS name_of_company, 
...
-- Answer: American Express, General Motors, Kaiser Permanente, Microsoft, Nike, and Unilever have the highest star ratings of 4.1999.
